            ...
            <div class="pt-[2.2rem] pb-5 md:pb-[4.7rem]">
                ...
                <div class="items-center justify-between md:flex">
                    <div class="flex gap-[10px] items-center">
                        ...
                        <div
                            class="w-5 h-5 border-[1px] border-solid border-gray_custom rounded-[0.3rem] flex items-center justify-center">
                            <i class="fa-solid fa-check" style="color: white;"></i>
                        </div>
                        <label for="keep_login"
                            class="text-lg font-medium cursor-pointer select-none text-blue_custom">Keep Me Logged
                            In</label>
                    </div>
                    <button type="button" onclick="openForgotPassword()"
                        class="flex text-sm font-normal hover:underline text-red_custom">Forgot Password</button>
                </div>
            </div>
            <div class="items-center justify-between md:flex">
                <p class="text-base mb-7 md:mb-0">Don't have an account? <a href="{{route('register')}}"
