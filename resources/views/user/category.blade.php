...
,"price"=>"100"],
    ...
    @endphp
    {{-- Title --}}
    <x-page-title-background img="https://preview.colorlib.com/theme/abcbook/assets/img/hero/h2_hero1.jpg.webp" titleName="Category"/>
    {{-- List item --}}
    <div class="px-3 mt-12">
        <div class="max-w-[1300px] w-full grid grid-cols-1 sm:grid-cols-[1fr,2fr] md:grid-cols-[0.8fr,2fr] lg:grid-cols-[0.6fr,2fr] gap-x-6 mx-auto">
            ...
            <div>
                <div class="flex justify-end">
                    <div class="relative w-2/3 py-3 border border-solid rounded-full md:w-2/5 lg:w-4/12 border-gray_custom font-roboto">
                        <x-select-custom mainId="popularity" mainTitle="Browse by popularity" :options="$popularityOptions"/>
                    </div>
                </div>
                <div class="grid w-full grid-cols-2 gap-2 sm:gap-4 md:gap-6 lg:grid-cols-4 md:grid-cols-3 mt-7">
                    ...
                    :stars="$bookItem['stars']"
                    :reviewers="$bookItem['reviewers']"
