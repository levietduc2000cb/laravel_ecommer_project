...
@section('content')
    {{-- Title --}}
    <x-page-title-background img="https://trumpwallpapers.com/wp-content/uploads/Book-Wallpaper-23-2803-x-1869.jpg" titleName="Track Order"/>
    {{-- Content --}}
    <div class="max-w-[1300px] py-20 w-full px-3 md:px-0 mx-auto grid grid-cols-1 md:grid-cols-2 gap-10">
        <div class="rounded-sm shadow-xl p-7 font-playfair">
            <div class="flex flex-col items-center justify-center py-3 border-b border-solid md:justify-between md:flex-row border-gray_custom_2">
            ...
            <div class="p-5">
                <div class="flex flex-col items-center md:justify-between md:items-start md:flex-row">
                    <div class="text-center">
                        ...
                        <button class="px-4 py-2 mb-3 border border-solid rounded outline-none hover:bg-blue_custom hover:text-white border-blue_custom text-blue_custom md:mb-0">Show Detail Product</button>
                   </div>
                    <div class="w-[11.25rem] aspect-[1/1.5]">
                        <img class="object-fill w-full h-full" src="https://kenosa.vn/app_images/product/2019/5/24/combo-sach-bac-ho-song-mai-nhung-truyen-hay-ve-bac-5-tap-101305-800-101305.jpg" alt="img-order">
                    </div>
                </div>
                <div></div>
            </div>
