...
<body>
    ...
    <div class="flex items-center justify-center min-h-screen">
        <form action="{{route('handle-register')}}" method="POST"
            class="max-w-[700px] w-full shadow-2xl p-5 md:p-12 m-2 md:m-4 lg:m-0">
            ...
            <div class="pt-[2.2rem] pb-5 md:pb-[3.75rem]">
                ...
                <div class="flex flex-col mb-5">
                    <label class="mb-[0.4rem] capitalize text-lg font-medium text-blue_custom" for="fullName">Full
                        Name</label>
                    <input type="text" required value="{{$name}}"
                        class="peer text-base px-6 py-4 border-[1px] border-solid border-gray_custom"
                        placeholder="Enter full name" name="fullName" id="fullName">
                    <p class="invisible peer-invalid:visible text-red_custom">Please enter your full name</p>
                </div>
                <div class="flex flex-col mb-5">
                    <label class="mb-[0.4rem] capitalize text-lg font-medium text-blue_custom" for="email">Email
                        Address</label>
                    <input type="{{$email}}" required value="Exam@gmail.com"
                        class="peer text-base px-6 py-4 border-[1px] border-solid border-gray_custom"
                ...
                <div class="flex flex-col mb-5">
                    <label class="mb-[0.4rem] capitalize text-lg font-medium text-blue_custom" for="phone">Phone
                        number</label>
                ...
                <div class="flex flex-col mb-5">
                    <label class="mb-[0.4rem] capitalize text-lg font-medium text-blue_custom"
                        for="password">Password</label>
                    <div class="relative w-full">
                        <input type="password" value="{{$password}}" required
                            class="peer w-[85%] md:w-[90%] text-base px-6 py-4 border-[1px] border-solid border-gray_custom"
                        ...
                        <button type="button" id="button_change-type-password"
                            class="w-[15%] md:w-[10%] absolute right-0 top-0 h-[70%] bg-gray_custom">
            ...
            <div class="items-center justify-between md:flex">
                <p class="text-base mb-7 md:mb-0">Already have an account? <a href="{{route('login')}}"
                        class="cursor-pointer text-red_custom hover:underline">Login</a> here</p>
