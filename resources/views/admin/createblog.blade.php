        ...
        <div class="flex flex-col-reverse gap-8 md:flex-row">
           <div class="flex-1 mt-1">
               ...
               <div>
                ...
                <div>
                    ...
                    <select name="blogtypes" class="w-full px-2 py-2 border border-solid border-gray_custom_2">
                        <option class="w-full" value="1" selected>1</option>
            ...
            <div class="flex items-center justify-center flex-1">
                <label for="blog_image_title" class="block w-full cursor-pointer">
                    <img src="{{asset('images/books/no-image.jpg')}}" alt="blog_image_title" class="w-full border border-solid rounded-md aspect-[2/1] object-contain border-darkRed_custom">
                </label>
                <input onchange="changeInputImg(event)" type="file" id="blog_image_title" name="image_title" placeholder="Input blog's title" class="w-full px-2 py-2 border border-solid outline-none peer border-gray_custom focus:border-gray_custom_3" hidden>
            </div>
        </div>
