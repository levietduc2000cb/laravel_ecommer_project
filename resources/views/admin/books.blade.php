    ...
    <div class="flex flex-col sm:flex-row gap-x-3">
        <div class="flex justify-start mt-2">
            ...
            <div id="modal_create_book" class="fixed !bg-[rgba(0,0,0,0.5)] top-0 left-0 right-0 h-screen flex justify-center items-center">
                <form action="{{route('admin_books_store')}}" method="post" class="w-11/12 max-h-screen p-4 overflow-y-scroll bg-white rounded md:overflow-visible md:w-7/12" enctype="multipart/form-data">
